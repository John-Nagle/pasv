/*
	Case-fixing program for Pascal programs

	Translates everything outside quotes and comments to lower case.
	Also removes underscores in program text.

	Version 1.7 of 2/4/81.
